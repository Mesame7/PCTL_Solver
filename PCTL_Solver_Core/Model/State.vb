Namespace Core.Model
    ...
    Public Class State
        ...
        Public Function GetNextStates() As List(Of State)
            Return _NextBranches.Select(Function(x) x.ToState).ToList
        End Function
        Public Function GetPreBranches() As List(Of Branch)
            Return _PreBranches
        End Function
        Public Function GetPreStates() As List(Of State)
            Return _PreBranches.Select(Function(x) x.FromState).ToList
        End Function
